...
class ByLetter:
    ...
    def __eq__(self, target):
        ...
        if self.letter is None or target.letter is None:
            result = False
        elif self.letter != target.letter:
            result = False
...
class ByCode:
    ...
    def __eq__(self, target):
        ...
        if self.letter == target.letter or self.code == target.code:
            result = True
...
def encode_morse(bst, text):
    ...
    for i in text:
        ...
        if i.isalpha():
            x = bst.retrieve(ByLetter(i.upper(), None))
            result += x.code + " "
        elif i.isspace():
            result += "\n"
...
def decode_morse(bst, code):
    ...
    for i in range(len(lst)):
        if lst[i] == "":
            ...
            ltr = ByCode(None, lst[i])
            value = bst.retrieve(ltr)
